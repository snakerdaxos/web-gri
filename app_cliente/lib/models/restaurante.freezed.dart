...
mixin _$Restaurante {
 ...
 String get id; String get nombre; String? get tipoCocina; String? get descripcion; String? get direccion; double get califProm; int get califCount;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,nombre,tipoCocina,descripcion,direccion,califProm,califCount);

@override
String toString() {
  return 'Restaurante(id: $id, nombre: $nombre, tipoCocina: $tipoCocina, descripcion: $descripcion, direccion: $direccion, califProm: $califProm, califCount: $califCount)';
}
...
@useResult
$Res call({
 String id, String nombre, String? tipoCocina, String? descripcion, String? direccion, double califProm, int califCount
});
...
/// Create a copy of Restaurante
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? nombre = null,Object? tipoCocina = freezed,Object? descripcion = freezed,Object? direccion = freezed,Object? califProm = null,Object? califCount = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String nombre,  String? tipoCocina,  String? descripcion,  String? direccion,  double califProm,  int califCount)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Restaurante() when $default != null:
return $default(_that.id,_that.nombre,_that.tipoCocina,_that.descripcion,_that.direccion,_that.califProm,_that.califCount);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String nombre,  String? tipoCocina,  String? descripcion,  String? direccion,  double califProm,  int califCount)  $default,) {final _that = this;
switch (_that) {
case _Restaurante():
return $default(_that.id,_that.nombre,_that.tipoCocina,_that.descripcion,_that.direccion,_that.califProm,_that.califCount);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String nombre,  String? tipoCocina,  String? descripcion,  String? direccion,  double califProm,  int califCount)?  $default,) {final _that = this;
switch (_that) {
case _Restaurante() when $default != null:
return $default(_that.id,_that.nombre,_that.tipoCocina,_that.descripcion,_that.direccion,_that.califProm,_that.califCount);case _:
  return null;
...
class _Restaurante extends Restaurante {
  const _Restaurante({required this.id, required this.nombre, this.tipoCocina, this.descripcion, this.direccion, this.califProm = 0.0, this.califCount = 0}): super._();
...
/// Create a copy of Restaurante
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? nombre = null,Object? tipoCocina = freezed,Object? descripcion = freezed,Object? direccion = freezed,Object? califProm = null,Object? califCount = null,}) {
