...
//     test $(grep -rn "length >= 8\|length < 8" lib/features | wc -l) -eq 0
// Ese gate NO SE PUEDE SATISFACER, y no por pereza: `lib/features` tiene SIETE
// coincidencias y solo TRES son puntos donde se FIJA una contrasena. Las otras
// cuatro estan en el camino de INICIAR SESION (`login_screen.dart` x2 y
...
const _puntosQueFijan = <String>[
  ...
  'lib/features/perfil/perfil_controller.dart',
];
