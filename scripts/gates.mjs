...
// ---------------------------------------------------------------------------
const BASELINES = {
  app_cliente: 439, // flutter test (11-30: 371 -> 408, la carta del menú: fotos, tarjetas y rejilla; 11-31: 408 -> 439, +31 del margen de 4 h para reservar HOY: 26 de dominio y 5 de wizard, MEDIDOS aparte del resto del árbol)
