...
// ---------------------------------------------------------------------------
const BASELINES = {
  app_cliente: 489, // flutter test (11-33: 466 -> 489, +23 del barrido de errores de stream: 11 en test/pedidos/errores_de_stream_test.dart, 8 en test/shared/errores_de_stream_pantallas_test.dart y 4 en test/pedidos/cuenta_320_test.dart. Delta MEDIDO corriendo solo los archivos nuevos. 11-30: 371 -> 408, la carta del menú: fotos, tarjetas y rejilla; 11-31: 408 -> 439, +31 del margen de 4 h para reservar HOY; 11-32: 439 -> 466, +27 de LA CUENTA del comensal: 14 del cálculo con cifras literales y 13 de la pantalla. Delta MEDIDO corriendo solo los dos archivos nuevos, no restando totales del árbol)
  panel_admin: 472, // flutter test (11-33: 460 -> 472, +12 del barrido de errores de stream: 10 en test/cocina/errores_de_stream_test.dart y 2 en test/shared/errores_que_mienten_test.dart. 11-29: 445 -> 446, 'Marcar ocupada' con la mesa disponible; 11-32: 446 -> 460, +14 de LA CUENTA DE LA MESA del mesero: 1 de ancla del formato, 6 del cálculo, 3 de la consulta y 4 de la pantalla)
  functions_unit: 149, // functions/: node --test test/*.test.js
  rules: 290, // scripts/: @firebase/rules-unit-testing contra el emulador (11-27: 221 -> 260, +39 casos de LECTURA DE DOCS AUSENTES; 11-28: 260 -> 282, +22 de QUERY vs RULES; 11-29: 282 -> 285, +3 de la FORMA de la tx de reserva futura; 11-31: 285 -> 290, +5 del MARGEN de 4 h server-side)
