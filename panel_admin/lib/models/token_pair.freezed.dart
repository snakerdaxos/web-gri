...
@JsonKey(name: 'access_token') String get access;@JsonKey(name: 'refresh_token') String get refresh;
...
@useResult
$Res call({
@JsonKey(name: 'access_token') String access,@JsonKey(name: 'refresh_token') String refresh
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'access_token')  String access, @JsonKey(name: 'refresh_token')  String refresh)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TokenPair() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'access_token')  String access, @JsonKey(name: 'refresh_token')  String refresh)  $default,) {final _that = this;
switch (_that) {
case _TokenPair():
return $default(_that.access,_that.refresh);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'access_token')  String access, @JsonKey(name: 'refresh_token')  String refresh)?  $default,) {final _that = this;
switch (_that) {
case _TokenPair() when $default != null:
return $default(_that.access,_that.refresh);case _:
  return null;
...
class _TokenPair implements TokenPair {
  const _TokenPair({@JsonKey(name: 'access_token') required this.access, @JsonKey(name: 'refresh_token') required this.refresh});
