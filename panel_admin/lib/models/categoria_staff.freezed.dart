...
mixin _$CategoriaStaff {
 ...
 int get id; String get nombre; int get orden; bool get activo; List<ProductoStaff> get productos;
...
$CategoriaStaffCopyWith<CategoriaStaff> get copyWith => _$CategoriaStaffCopyWithImpl<CategoriaStaff>(this as CategoriaStaff, _$identity);
  ...
  /// Serializes this CategoriaStaff to a JSON map.
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,nombre,orden,activo,const DeepCollectionEquality().hash(productos));

@override
String toString() {
  return 'CategoriaStaff(id: $id, nombre: $nombre, orden: $orden, activo: $activo, productos: $productos)';
}
...
@useResult
$Res call({
 int id, String nombre, int orden, bool activo, List<ProductoStaff> productos
});
...
/// Create a copy of CategoriaStaff
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? nombre = null,Object? orden = null,Object? activo = null,Object? productos = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String nombre,  int orden,  bool activo,  List<ProductoStaff> productos)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CategoriaStaff() when $default != null:
return $default(_that.id,_that.nombre,_that.orden,_that.activo,_that.productos);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String nombre,  int orden,  bool activo,  List<ProductoStaff> productos)  $default,) {final _that = this;
switch (_that) {
case _CategoriaStaff():
return $default(_that.id,_that.nombre,_that.orden,_that.activo,_that.productos);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String nombre,  int orden,  bool activo,  List<ProductoStaff> productos)?  $default,) {final _that = this;
switch (_that) {
case _CategoriaStaff() when $default != null:
return $default(_that.id,_that.nombre,_that.orden,_that.activo,_that.productos);case _:
  return null;
...
class _CategoriaStaff implements CategoriaStaff {
  const _CategoriaStaff({required this.id, required this.nombre, required this.orden, required this.activo, required  List<ProductoStaff> productos}): _productos = productos;
  factory _CategoriaStaff.fromJson(Map<String, dynamic> json) => _$CategoriaStaffFromJson(json);
...
@override List<ProductoStaff> get productos {
...
@override
Map<String, dynamic> toJson() {
  return _$CategoriaStaffToJson(this, );
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,nombre,orden,activo,const DeepCollectionEquality().hash(_productos));
...
/// Create a copy of CategoriaStaff
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? nombre = null,Object? orden = null,Object? activo = null,Object? productos = null,}) {
