...
| 🍽️ | `features/auth/login_screen.dart:222` | `restaurant` | `marca` | 32 |
| 🍽️ | `features/bootstrap/bootstrap_screen.dart:305` | `restaurant` | `marca` | 32 |
| 🍽️ | `features/cocina/cocina_screen.dart:178` | `restaurant` | `marca` | 20 |
| 🍽️ | `features/cocina/cocina_screen.dart:293` | `restaurant` | `marca` | 14 |
| 🍽️ | `features/cocina/widgets/pedido_card.dart:267` | `restaurant` | `marca` | 14 |
| 🎉 | `features/cocina/cocina_screen.dart:106` | `celebration_outlined` | `todoAlDia` | 18 |
| 📝 | `features/cocina/widgets/pedido_card.dart:153` | `edit_note` | `notas` | 14 |
| 🪑 | `features/dashboard/dashboard_screen.dart:149` | `table_restaurant_outlined` | `mesas` | 25 |
| 👥 | `features/dashboard/dashboard_screen.dart:156` | `people_outline` | `clientes` | 25 |
| 📅 | `features/dashboard/dashboard_screen.dart:163` | `calendar_today_outlined` | `reservas` | 25 |
| 📋 | `features/dashboard/dashboard_screen.dart:170` | `receipt_long_outlined` | `pedidos` | 25 |
| 🏪 | `features/dashboard/dashboard_screen.dart:388` | `storefront_outlined` | `restaurante` | 34 |
| 👇 | `features/dashboard/dashboard_screen.dart:388` | `arrow_upward` | `selectorArriba` | 34 |
| 👥 | `features/dashboard/widgets/mesa_tile.dart:70` | `people_outline` | `clientes` | 12 |
| 🪪 | `features/equipo/equipo_screen.dart:134` | `badge_outlined` | `equipo` | 40 |
...
| ⚠️ | `features/mesas/mesa_form_dialog.dart:239` | `warning_amber_outlined` | `aviso` | 13 |
| 🖨️ | `features/mesas/qr_dialog.dart:50` | `print_outlined` | `imprimir` | 14 |
| 📅 | `features/reportes/reportes_screen.dart:131` | `calendar_today_outlined` | `reservas` | 14 |
| 📅 | `features/reportes/reportes_screen.dart:138` | `calendar_today_outlined` | `reservas` | 14 |
| 💵 | `features/reportes/reportes_screen.dart:251` | `payments_outlined` | `ventas` | 25 |
| 🧾 | `features/reportes/reportes_screen.dart:259` | `receipt_outlined` | `ticket` | 25 |
