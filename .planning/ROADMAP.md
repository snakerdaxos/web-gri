...
- [x] 11-06-PLAN.md — Ola 2: ver/ocultar contraseña en los 5 campos + confirmar contraseña en el registro
- [x] 11-07-PLAN.md — Ola 3: Cloud Function de bootstrap del primer super_admin (guarda atómica, correo verificado + secreto) + pantalla `/bootstrap` con ruta exenta del guard
- [x] 11-18-PLAN.md — Ola 3: branding GRI en LAS DOS apps (generador de assets, manifest, favicon, ícono, splash) + `audit:branding`
- [x] 11-08-PLAN.md — Ola 4: callable `crearUsuarioStaff` con la matriz de roles, anti-secuestro y su combinatoria de escalada
- [x] 11-09-PLAN.md — Ola 4: estados vacíos guiados y pantalla 404 propia en ambas apps
- [x] 11-17-PLAN.md — Ola 4: login con Google en la app cliente (rama Web ya funcional; corrección del appId de Android al registro correcto + checkpoint de la huella SHA-1)
- [x] 11-10-PLAN.md — Ola 5: panel — pantalla de equipo adaptativa por rol + regla de lectura acotada al `rid` (11-10-SUMMARY.md)
- [x] 11-11-PLAN.md — Ola 5: tokens de diseño (espaciado, radios, breakpoints), escala tipográfica y colores semánticos
- [ ] 11-13-PLAN.md — Ola 6 (VISIBLE, en paralelo): TODO lo visual de app_cliente — zona segura (SafeArea), fin del maxWidth 480, overflow del wizard y sus ~46 emojis → iconos
- [ ] 11-21-PLAN.md — Ola 6 (VISIBLE, en paralelo): TODO lo visual de panel_admin — sidebar 85px, StatCard 31px, ResponsivePage, overflow de reservas y sus ~47 emojis → iconos
